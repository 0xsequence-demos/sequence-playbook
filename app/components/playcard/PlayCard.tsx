...
function PlayCardRoot({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col sm:rounded-[12px] text-13 bg-deep-purple-950 border border-white/10 overflow-hidden">
      {children}
    </div>
  );
}
...
function PlayPreview({
  ...
  return (
    <div className="flex flex-col items-center p-8 bg-gradient-to-b from-white/[4%] to-white/[2%] border-b border-white/5">
