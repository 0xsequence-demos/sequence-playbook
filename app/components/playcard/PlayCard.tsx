...
function PlayCardRoot({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col sm:rounded-[12px] text-13 bg-deep-purple-950/50 backdrop-blur-md border border-white/10 overflow-hidden w-[calc(100%_+_2rem)] ml-[-1rem] md:ml-0 md:w-auto border-x-0 md:border-x">
      {children}
    </div>
  );
}
...
function PlayPreview({
  ...
  return (
    <div className="flex flex-col items-center p-4 md:p-8  border-b border-white/5">
